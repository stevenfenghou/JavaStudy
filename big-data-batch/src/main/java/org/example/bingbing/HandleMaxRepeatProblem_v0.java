...
public class HandleMaxRepeatProblem_v0 {
    ...
    public static final String dir = "D:\\temp";

    public static final String FILE_NAME = "D:\\temp\\User.dat";
    ...
    private static void readData() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (count % 100 == 0) {
                System.out.println("读取100行,总耗时间: " + (System.currentTimeMillis() - start) + " ms");
                try {
                    Thread.sleep(1000L);
