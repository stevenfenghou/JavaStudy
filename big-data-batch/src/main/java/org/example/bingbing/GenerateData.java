...
public class GenerateData {
    ...
    public void generateData() throws IOException {
        File file = new File("D:\\temp\\User.dat");
        if (!file.exists()) {
            try {
                file.createNewFile();
            } catch (IOException e) {
        ...
        BufferedWriter bos = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file, false)));
        ...
        System.out.println("写入完成! 共花费时间:" + (System.currentTimeMillis() - startTime) + " ms");
        bos.close();
    }
