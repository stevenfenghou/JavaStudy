...
public class ReadZipFileMultThread2 {
    private static final Logger LOGGER = LoggerFactory.getLogger(ReadZipFileMultThread2.class);
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    private static final String FILE_NAME = "D:\\temp\\jsonData1.zip";
    private static final Executor excuter = Executors.newFixedThreadPool(5);
    private static final Executor excuter2 = Executors.newFixedThreadPool(2);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 8; i++) {
           ...
           // new Thread(() -> readZipFile("D:\\temp\\jsonData" + finalI + ".zip")).start();
            excuter2.execute(() -> readZipFile("D:\\temp\\jsonData" + finalI + ".zip"));
        }
